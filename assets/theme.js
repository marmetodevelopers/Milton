  ...
  theme.Variants = (function () {
    ...
    Variants.prototype = Object.assign({}, Variants.prototype, {
      ...
      _onSelectChange: function ({ srcElement }) {
        ...
        /**
         * Logic to update product variant data passed to breeze checkout
         */
        const breezeButtons = document.getElementsByTagName("breeze-button");
        console.log(
          "DEBUGGING::updatebreezebuttonvariant",
          this.currentVariant,
          breezeButtons
        );
        if (!this.currentVariant.available) {
          for (const breezeButton of breezeButtons) {
        ...
        if (breezeButtons.length > 0) {
          breezeButtons[breezeButtons.length - 1].setAttribute(
            "selectedproductvariantdata",
            btoa(JSON.stringify(this.currentVariant))
          );
          breezeButtons[0].setAttribute(
            "selectedproductvariantdata",
            btoa(JSON.stringify(this.currentVariant))
          );
        }
 ...
 setTimeout(()=>{ fetch(theme.routes.cartAdd, {
  ...
  theme.headerSearch = (function () {
    ...
    function close(evt) {
      ...
      document.dispatchEvent(
        new CustomEvent("predictive-search:close", { bubbles: true })
      );
  ...
  theme.VendorProducts = (function () {
    function VendorProducts(container) {
      ...
      this.maxProducts = parseInt(
        this.container.getAttribute("data-max-products"),
        10
      );
        ...
        fetch(url)
          ...
          .then((text) => {
            ...
            allProds.forEach((el) => {
              ...
              const modal = html.querySelector(
...
/* product page gift wrapper */
// Function to handle checkbox change
// Function to remove additional product when main product is deleted
// Function to remove linked products when main product is deleted
// Function to handle checkbox change
// Function to handle checkbox change
// Function to handle checkbox change
// Function to handle checkbox change
